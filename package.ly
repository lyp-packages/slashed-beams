%{
Forked from the OpenLilyLib notation-snippets directory:

  https://github.com/openlilylib/snippets/blob/master/notation-snippets/slash-beam

Original code by Andrew Bernard <andrew.bernard@gmail.com>
%}
